...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED6_Pin|LED7_Pin|LED5_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, LED8_Pin|LED9_Pin|LED10_Pin, GPIO_PIN_RESET);
  ...
  HAL_GPIO_WritePin(GPIOD, LED4_Pin|LED3_Pin|LED2_Pin|LED1_Pin
                          ...
                          |Motor_ST_SR_Pin|Motor_ST_PHASE_Pin|Motor_FL_SR_Pin|Motor_FL_PHASE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, Motor_RL_SR_Pin|Motor_RL_PHASE_Pin, GPIO_PIN_RESET);
